        ...
        <div class="kf_inr_ban_des">
          ...
          <div class="kf_inr_breadcrumb">
            <ul>
              ...
              <li><a href="<?php echo base_url(); ?>courses/online">Online Courses</a></li>
            </ul>
          </div>
        </div>
...
<div class="search_bar_outer_wrap">
  <div class="container">
    <?php /*?><div class="inr_pg_search_wrap">
      <form method="post" action="<?php echo base_url(); ?>courses/search_online" >
        <div class="search_bar_des">          
		  ...
		  <input type="hidden" name="course_type" value="online"    />
        </div>
