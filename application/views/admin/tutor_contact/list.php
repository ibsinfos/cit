 <div id="page-wrapper">
            <div class="container-fluid">
               <div class="row bg-title">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                     <h4 class="page-title">Tutor contact</h4>
                  </div>
                  <!-- /.page title -->
                  <!-- .breadcrumb -->
          ...
          <ol class="breadcrumb">
                        ...
                        <li class="active">Tutor contact</li>
                     </ol>
                  </div>
                  <!-- /.breadcrumb -->
               </div>
...
<div class="col-sm-12">
 <div class="white-box">
 <h3 class="box-title m-b-0">Tutor contact</h3> <br />
 <!--<p class="text-muted m-b-20"> <a href="<?php echo base_url(); ?>admin/register_students/add" class="btn btn-success btn-rounded" > Add New</a></p>-->
              ...
              foreach($tutor_contact as $row)
              {
					...
					echo '<td class="text-nowrap">  
					   <a onclick="return getConfirmation();" href="'.site_url("admin").'/tutor_contact/delete/'.$row['id'].'" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a>
					</td>';
					echo '</tr>';
              }
              ?> 
