 ...
 <div id="page-wrapper" >
            <div class="container-fluid">
               <div class="row bg-title">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                     <h4 class="page-title">View student ebooks</h4>
                  </div>
          ...
          <ol class="breadcrumb">
                        ...
                        <li class="active">View student ebooks</li>
                     </ol>
                  </div>
...
?>
                                ...
                                <div class="form-group">
                                    <b>Title :</b>
                                        ...
                                        <?php  echo $student_ebooks[0]['se_title']; ?>
								...
								<div class="form-group">
                                    <label class="col-md-12"><b>Courese  : </b><?php 
										  ...
										  $results=$query->result();							  
										   ...
										   {
											   if($student_ebooks[0]['se_course_id']==$row->course_id)
								...
								<div class="form-group">
                                    <label class="col-md-12"> <b>Book Image :</b></label>
                                    <div class="col-md-12">
								...
								<div class="form-group">
                                    <label class="col-md-12"><b>Book Author  : </b></label>
                                    <div class="col-md-12">
                                      <p>  <?php echo $student_ebooks[0]['se_author']; ?></p>
										
										</div>
                                </div>
								
								<div class="form-group">
                                    <label class="col-md-12"><b>No Of Page  : </b></label>
                                    <div class="col-md-12">
                                      <p>  <?php echo $student_ebooks[0]['se_page_no']; ?></p>
