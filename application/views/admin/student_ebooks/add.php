...
<div class="col-sm-12">
<div class="white-box">
<h3 class="box-title m-b-0">Add student ebooks </h3> <br />

								<?php
								$attributes = array('class' => 'form-horizontal', 'id' => '');
								echo validation_errors();

								echo form_open_multipart('admin/student_ebooks/add', $attributes);
								?>
                              ...
                              <div class="form-group">
								...
								<div class="form-group">
                                    <label class="col-md-12">Upload Pdf (PDF Max Size:2MB Only)</label>
                                    <div class="col-md-12">
                                        <input type="file"  class="form-control" name="pdf_image"  >
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
									<input type="text" required class="form-control" name="author_name" value="<?php echo set_value('author_name'); ?>" >
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
									<input type="text" required class="form-control" name="page_no" value="<?php echo set_value('page_no'); ?>" >
