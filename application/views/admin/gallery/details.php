...
?>
                                ...
                                <label class="col-md-12">    <b> Name :</b> <?php  echo $testimonials[0]['name']; ?></label>
								...
								<div class="form-group">
                                    <label class="col-md-12"><b>Designation :</b> <?php echo $testimonials[0]['designation']; ?></label>
                                    <div class="col-md-12">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                      <p>  <?php echo $testimonials[0]['testimonial_des']; ?></p>
