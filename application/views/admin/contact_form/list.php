...
<div class="col-sm-12">
 <div class="white-box">
 <h3 class="box-title m-b-0">contact form </h3> <br />
 <!--<p class="text-muted m-b-20"> <a href="<?php echo base_url(); ?>admin/newsletters/add" class="btn btn-success btn-rounded" > Add New</a></p>-->
              ...
              foreach($contact_form as $row)
              {
					...
					echo '<td class="text-nowrap">					   
					   <a onclick="return getConfirmation();" href="'.site_url("admin").'/contact_form/delete/'.$row['cf_id'].'" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a>
					</td>';
					echo '</tr>';
              }
              ?> 
