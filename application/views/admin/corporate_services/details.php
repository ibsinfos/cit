 ...
 <div id="page-wrapper" >
            <div class="container-fluid">
               <div class="row bg-title">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                     <h4 class="page-title">View Corporate Training</h4>
                  </div>
          ...
          <ol class="breadcrumb">
                        ...
                        <li class="active">View Corporate Training</li>
                     </ol>
                  </div>
...
?>
								...
								<div class="form-group">
                                    <label class="col-md-12"><b>Title :</b> <?php echo $corporate_services[0]['title']; ?></label>
                                    <div class="col-md-12">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                      <p>  <?php echo $corporate_services[0]['corporate_services_des']; ?></p>
