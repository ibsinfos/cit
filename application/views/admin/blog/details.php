...
?>
                                ...
                                <label class="col-md-12"><b> Post Date :</b> <?php  echo $blog[0]['blog_date']; ?></label>
								...
								<div class="form-group">
                                    <label class="col-md-12"><b>Title :</b> <?php echo $blog[0]['title']; ?></label>
                                    <div class="col-md-12">
