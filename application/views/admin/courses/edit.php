...
?>
						...
						<select  class="form-control" name="course_type" value="<?php echo set_value('course_type'); ?>" >
								...
								<div class="form-group">
                                    <label class="col-md-12">Course Search Tags <b>(Each word seperate by cama)</b></label>
                                    <div class="col-md-12">
                                        <input type="text" id="" class="form-control" name="course_tags" value="<?php echo $courses[0]['course_tags']; ?>" >
 ...
 <?php } ?>  
     ...
     <br />  <br /> 		
					...
					<?php */ ?>			
                                        ...
                                        <a href="<?php echo base_url(); ?>/admin/courses" class="btn btn-inverse waves-effect waves-light">Cancel</a>
                                   <?php echo form_close(); ?>
