...
?>
                                ...
                                <label class="col-md-12"><b> Name :</b> <?php  echo $banners[0]['name']; ?></label>
								...
								<div class="form-group">
                                    <label class="col-md-12"><b>Title :</b> <?php echo $banners[0]['title']; ?></label>
                                    <div class="col-md-12">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                      <p>  <?php echo $banners[0]['banner_des']; ?></p>
