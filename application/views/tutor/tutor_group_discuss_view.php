      ...
      <div class="row">
        ...
        <div class="row">
            	<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 well stdashcour">
                	<div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <a href="#" class="btn btn-darkred btn-lg hunper"><i class="fa fa-bullhorn"></i> Ask Question</a>
                        </div>
                    </div>
                </div>
            </div>
      		<div class="tabautoscr">
                ...
                <tr>
                    <td><a href="<?php echo base_url(); ?>tutor_dashboard/gd_answer_question/<?php echo $row->question_id; ?>" class="qlink"><?php echo $row->qs_title; ?></a></td>
                    <td align="center">
					<?php
                    ...
                    <td>
                        <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>tutor_dashboard/gd_answer_question/<?php echo $row->question_id; ?>"><i class="fa fa-eye"></i> View</a> 
                        <!--<a class="btn btn-sm btn-danger" href="#"><i class="fa fa-close"></i> Delete</a>-->
                    </td>
                </tr>
				<?php endforeach; ?>
