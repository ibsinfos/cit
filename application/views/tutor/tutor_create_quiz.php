  ...
  <div class="container">
    <div class="row">
      ...
      <div class="row">
            ...
            <a class="hvr-wobble-vertical btn btn-primary btn-md pull-right" href="<?php echo base_url(); ?>tutor_dashboard/quiz" style="border-radius:0px;"><i class="fa fa-angle-left"></i> Back</a>
        </div>
            </div>
        </div>
        <hr style="margin-top:0px;"/>
            <div class="blog_pg_form">
				...
				<?php endif; ?>
                <form method="post" action="<?php echo base_url(); ?>tutor_dashboard/create_quiz" enctype="multipart/form-data" >
                    <div class="row">   
                        ...
                        <div class="col-md-12 col-sm-12" style="display:block;">
                         <p><strong>Upload Questions File(File Type Should Only PDF,doc,docx AND Max Size: 2MB) </strong></p>
