						...
						<div class="col-md-3">
							<div class="widget">
								...
								<ul class="cont_socil_meta">
                                    ...
                                    <li><a href="<?php echo $res_setting->instagram; ?>" ><i class="fa fa-instagram "></i></a></li>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="copyright_des">
							<span>&copy; All Rights reserved. chicago institute of technology, <br>Powered By <a href="www.digitekitinc.com" target="_blank"><img src="<?php echo base_url(); ?>images/digitek_logo.png" alt="" width="120" height="20"/></a></span>					  </div>
				  </div>
