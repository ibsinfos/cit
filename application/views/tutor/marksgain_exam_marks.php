  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9 col-sm-12 col-xs-12">
        ...
        <div class="row" >
		<form method="post" action="<?php echo base_url(); ?>tutor_dashboard/marksgain_exam_marks/<?php echo $this->uri->segment(3); ?>" >
          <div class="details col-md-6">
   
              
              <div class="form-group name">
                <label for="name">Marksagain</label>
