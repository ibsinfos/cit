    ...
    <div class="row">
      ...
      <div class="col-md-9 col-sm-12 col-xs-12">
        ...
        <div class="row">
            ...
            <a class="hvr-wobble-vertical btn btn-primary btn-md pull-right" href="<?php echo base_url(); ?>tutor_dashboard/<?php echo 'group_discussion_view1/'; ?><?php echo $this->session->userdata('gd_course_id'); ?>/<?php echo $this->session->userdata('gd_batch_id'); ?>"><i class="fa fa-angle-left"></i> Back</a>
        </div>
            </div>
        </div>
		...
		<?php endforeach; ?>
          ...
          <!-- BLOG PG FORM START-->
	    						<div class="blog_pg_form">
	    							...
	    							<form method="post" action="<?php echo base_url(); ?>tutor_dashboard/gd_answer_post/<?php echo $this->uri->segment(3); ?>" >
	    								<div class="row">	    									
	    									<div class="col-md-12">
