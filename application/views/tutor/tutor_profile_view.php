    ...
    <div class="row">
      ...
      <div class="col-md-9 col-sm-12 col-xs-12">
		...
		<?php if(validation_errors() || isset($error)) : ?>
				...
				<?php endif; ?>
		  <form method="post" action="<?php echo base_url(); ?>tutor_dashboard/profile" enctype="multipart/form-data" >
          ...
          <div class="details col-md-6">
			...
			<?php if(!empty($res_std->tutor_image)){ ?>
              <div class="form-group name">
                <label for="name">Tutor Image</label>
				
                <img src="<?php echo base_url(); ?>images/tutor/<?php echo $res_std->tutor_image; ?>" width="120" height="120">
              </div>
			<?php } ?>
