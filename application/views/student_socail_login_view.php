										...
										?>
                                                    <div class="input-holder">
                                                        <label for="cs-email-1">
                                                            <strong>Username</strong>
                                                            <i class="icon-add-user"></i>
                                                            <input type="text" class="" id="forgotpwd-cs-email" placeholder="Enter Username ">
                                                        </label>
                                                    </div>
                                                    <div class="input-holder">
      ...
      <div class="col-md-12">
        ...
        <div class="kf_inr_ban_des">
          <div class="inr_banner_heading">
            <h3> Your first time login , Please Choose username</h3>
          </div>
...
<!--Content Wrap Start-->
    	<div class="kf_content_wrap">
    		...
    		<section>
    			<div class="container">
    		<div class="row">
			  <!--<p><b>Your first time login , Please Choose username</b></p>-->
			   <div class="details col-md-6">
				<?php //echo validation_errors(); ?>
				<form method="post" action="<?php echo base_url(); ?>Student_socail_login/submit" >
