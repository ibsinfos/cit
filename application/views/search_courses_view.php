...
<div class="search_bar_outer_wrap">
  <div class="container">
    <?php /*?><div class="coursesearch">
    	<div class="inr_pg_search_wrap">
      <form method="post" action="<?php echo base_url(); ?>courses/search_all" >
        <div class="search_bar_des">          
         
          <input type="search" name="hcourse_title" value="<?php echo $posted_data['course_title'] ?>"   placeholder="Search Course Title"   />
        </div>
        <button type="submit" name="course_search_btn_mn" value="1" >Search Now</button>
      </form>
    </div>
    </div><?php */?>
  </div>
