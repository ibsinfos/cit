...
class Admin_manufacturers extends CI_Controller {
    ...
    */
    ...
    {
        parent::__construct();
        $this->load->model('admin/manufacturers_model');
    ...
    */
    public function index()
    {
		...
		$this->load->view('admin/manufacturers/list', $data); 
    ...
    public function add()
    {
		...
		$this->load->view('includes/header', $data);  
		$this->load->view('includes/left_sidebar', $data);
		$this->load->view('admin/manufacturers/add', $data); 
		$this->load->view('includes/footer', $data); 
    ...
    */
    public function update()
    {
		...
		$this->load->view('includes/header', $data);  
		$this->load->view('includes/left_sidebar', $data);
		$this->load->view('admin/manufacturers/edit', $data); 
		$this->load->view('includes/footer', $data); 	
