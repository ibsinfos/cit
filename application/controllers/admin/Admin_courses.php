...
public function index()
{
	...
	$config['num_links'] =$this->courses_model->count_courses();
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            $this->form_validation->set_error_delimiters('<div class="alert alert-error"><a class="close" data-dismiss="alert">×</a><strong>', '</strong></div>');
                ...
                $data_to_store = array(
					...
					'course_tags' => trim($this->input->post('course_tags')),
...
public function details()
{
	...
	$data['courses'] = $this->courses_model->get_courses_by_id($id);
	$data['main_content'] = 'admin/courses/details';
	$this->load->view('includes/header', $data);  
	$this->load->view('includes/left_sidebar', $data);
